    ...
    <el-card shadow="hover">
      ...
      <div class="row">
        <el-upload
          ...
          :name="cfg.name"
          :with-credentials="cfg.withCredentials"
          :show-file-list="cfg.showFileList"
          :drag="cfg.drag"
          :accept="cfg.accept"
          ...
          :list-type="cfg.listType"
          :auto-upload="cfg.autoUpload"
          :file-list="fileList"
          :http-request="cfg.customRequest ? customRequest : undefined"
          :disabled="cfg.disabled"
          :limit="cfg.limit"
          :on-exceed="handleExceed"
          :on-before-upload="onBeforeUpload"
          :on-before-remove="onBeforeRemove"
          :on-after-read="onAfterRead"
          :on-oversize="onOversize"
          :before-read="beforeRead"
          :after-read="afterRead"
          :max-size="cfg.maxSize"
          :max-count="cfg.maxCount"
          :result-type="cfg.resultType"
          :upload-text="cfg.uploadText"
          :upload-icon="uploadIconComp"
          :delete-icon="deleteIconComp"
          :preview-icon="previewIconComp"
          :tip="cfg.tip"
          :trigger="cfg.trigger"
